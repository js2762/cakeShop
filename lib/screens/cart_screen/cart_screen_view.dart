            ...
            children: [
              Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.read<CartCubit>().toggleVisibility();
                    },
                    child: Image.asset(
              ...
              Visibility(
                visible: context.watch<CartCubit>().isVisible,
                child: Padding(
                  padding: const EdgeInsets.only(top: 15),
                  child: TextField(
                    controller:
                        context.read<CartCubit>().searchControllerCartItem,
                    onChanged: (value) {
                      context.read<CartCubit>().searchedElement(value);
                    },
                                ...
                                IconButton(
                                  onPressed: () {
                                    BlocProvider.of<CartCubit>(context)
                                        .removeFromCart((state.cartItemList[index]['itemData'] as CakeData).name.toString());
                                  },
                                  icon: const Icon(
