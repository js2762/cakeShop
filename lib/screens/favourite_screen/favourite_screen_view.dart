            ...
            children: [
              Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.read<FavouriteCubit>().toggleVisibility();
                    },
                    child: Image.asset(
              ...
              Visibility(
                visible: context.watch<FavouriteCubit>().isVisible,
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      context.read<FavouriteCubit>().searchedElement(value);
                    },
                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () {
                                    ...
                                    context.read<HomeCubit>().updateFavouriteStatus2(state.favouriteItemList[index].name.toString());
                                    ///BlocProvider.of<HomeCubit>(context).updateFavouriteStatus2(state.favouriteItemList[index].name.toString());
                                    context.read<FavouriteCubit>().removeFromFavourite(state.favouriteItemList[index].name.toString());
                                  },
                                  icon: const Icon(
