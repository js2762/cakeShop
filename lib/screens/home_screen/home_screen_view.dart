...
import 'package:online_cake_shop/screens/home_screen/cubit/home_cubit.dart';
...
class HomeScreenView extends StatelessWidget {
  ...
  final HomeCubit _list1Cubit = HomeCubit();
  final HomeCubit _list2Cubit = HomeCubit();
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context).pushNamed(FavouriteScreenView.routeName); ///arguments: _list2Cubit
                        },
                        child: CircleAvatar(
                          backgroundColor: Colors.white,
                          radius: 20,
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: _list1Cubit.selectedIndex == index
                                ? selectedCategory(
                          ...
                          return InkWell(
                            ...
                            child: customCakeCard(
                             itemData: state.itemList2[index],
                              //homeCubitInstance: _list2Cubit,
                              index: index,
                              context: context,
                              // homeInstance: _list2Cubit,
                            ),
                          );
                        },
                      ),
...
Widget customCakeCard({
 ...
 // required HomeCubit homeCubitInstance,
  required int index,
 // required HomeCubit homeInstance,
}) {
  return Container(
    height: 300,
    width: 225,
              ...
              Positioned(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    context.read<HomeCubit>().updateFavouriteStatus(index);
                    context.read<FavouriteCubit>().addToFavourite(itemData);
                  },
                  child: CircleAvatar(
