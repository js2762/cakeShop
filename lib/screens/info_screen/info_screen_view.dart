...
import 'package:online_cake_shop/screens/info_screen/cubit/info_cubit.dart';
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              context.read<InfoCubit>().decrement();
                            },
                            child: CircleAvatar(
                          ...
                          InkWell(
                            onTap: () {
                              context.read<InfoCubit>().increment();
                            },
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () async {
                              if (context.read<InfoCubit>().itemCount > 0) {
